...
ORCA-LF GitHub organization (established as Open Robust Compartmentalization Alliance (ORCA) a Series of LF Projects, LLC, the "Project"). The Project and its participants
must adhere to the requirements in this document and the policies of LF Projects, LLC, available at www.lfprojects.org/policies. This document is derived from
...
* Administer the ORCA-LF GitHub organization, including managing GitHub Team
...
one-year terms, meaning all seats are open for community vote every year.

With the exception of the inaugural TSC election, one month before the
expiration of a TSC Member term, the current TSC shall open a call for
nominations to fill all open seats. Any community Participant
...
Nominations are collected via Google form. Nominees and decisions must be
publicly recorded on the ORCA TSC GitHub repository for transparency.
...
### 2.3 TSC Member Vacancies

TSC Members should resign if they become unable to perform the duties outlined in Section 2.1.
If a TSC Member becomes inactive for an extended period of time and/or becomes unreachable, their removal is at the discretion of a simple majority of active TSC Members.

When a TSC Member resigns or is removed, the vacancy is handled as follows:

**Interim Appointment**: The TSC may designate a short-term replacement to fill the vacant seat via the procedure for nominations and elections described in section 2.2.

* In addition to the TSC vote, the nominated replacement should also confirm their proposed appointment.
* If the vacancy is due to a planned resignation, the resigning TSC Member is encouraged to participate in the vote to designate their successor.
...
**3.2. Appeal Process.** Decisions may be appealed via a GitHub pull request
or an issue. The applicable Maintainer will consider the appeal in
good faith and respond in writing within a reasonable time.
...
repository may be amended with a simple majority vote (currently 3 out of 5) of the Technical Steering Committee
