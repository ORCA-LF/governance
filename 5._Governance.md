...
ORCA-LF GitHub organization (established as Open Robust Compartmentalization Alliance (ORCA) a Series of LF Projects, LLC  a Series of LF Projects, LLC, the "Project"). The Project and its participants
...
by not performing the duties as stated in 2.1. When a TSC Member resigns or is
...
publicly recorded on the ORCA Governance GitHub repository for transparency.
