...
TSC Members must resign if they become inactive for an extended period of time,
by failing to perform the duties outlined in Section 2.1. When a TSC Member resigns or is
removed, an election must be held to replace the Member, following the procedure
for nominations and elections as discussed above.
